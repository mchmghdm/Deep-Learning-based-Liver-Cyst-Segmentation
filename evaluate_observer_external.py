# here we are reading dr Prince gt from biomarker files that has mltiple labels so we need to adjust the labels so we only have liver cysts
...
def compute_metrics(reference_file: str, prediction_file: str, image_reader_writer: BaseReaderWriter,
    ...
    seg_ref[np.isclose(seg_ref , 5.)] = 0
    seg_ref[np.isclose(seg_ref , 8.)] = 0
    seg_ref[np.isclose(seg_ref , 25.)] = 0
    seg_ref[np.isclose(seg_ref , 26.)] = 1
...
if __name__ == '__main__':
    ...
    folder_obs1 = '/home/mina/16_liver_test_external_masks/gt_Prince/'
    
    folder_obs2 = '/home/mina/16_liver_test_external_masks/ModelOutputMultiChannel/'
    ...
    output_file = '/home/mina/16_liver_test_external_masks/summary_Prince_ModelMultiChannel.json'
